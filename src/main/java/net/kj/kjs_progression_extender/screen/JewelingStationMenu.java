...
public class JewelingStationMenu extends AbstractContainerMenu {
    ...
    public JewelingStationMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.JEWELING_STATION_MENU.get(), pContainerId);
        checkContainerSize(inv, 3);
        blockEntity = ((JewelingStationBlockEntity) entity);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 56, 51));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 102, 51));
        });
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.JEWELING_STATION.get());
    }
