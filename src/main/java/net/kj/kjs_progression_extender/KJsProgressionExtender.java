...
@Mod(KJsProgressionExtender.MOD_ID)
public class KJsProgressionExtender
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "kjs_progression_extender";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public KJsProgressionExtender(FMLJavaModLoadingContext context)
    {
