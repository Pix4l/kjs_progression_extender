package net.kj.kjs_progression_extender.datagen.recipe;
...
public class UpgradeRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    ...
    public UpgradeRecipeBuilder(RecipeCategory pCategory, ItemLike pResult, int pCount) {
     ...
     */
    public static UpgradeRecipeBuilder shaped(RecipeCategory pCategory, ItemLike pResult) {
     ...
     * Creates a new builder for a shaped recipe.
     */
    public static UpgradeRecipeBuilder shaped(RecipeCategory pCategory, ItemLike pResult, int pCount) {
        return new UpgradeRecipeBuilder(pCategory, pResult, pCount);
    }

    /**
     * Adds a key to the recipe pattern.
     */
    public UpgradeRecipeBuilder define(Character pSymbol, TagKey<Item> pTag) {
     ...
     * Adds a key to the recipe pattern.
     */
    public UpgradeRecipeBuilder define(Character pSymbol, ItemLike pItem) {
     ...
     * Adds a key to the recipe pattern.
     */
    public UpgradeRecipeBuilder define(Character pSymbol, Ingredient pIngredient) {
     ...
     */
    public UpgradeRecipeBuilder pattern(String pPattern) {
    ...
    public UpgradeRecipeBuilder showNotification(boolean pShowNotification) {
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        pFinishedRecipeConsumer.accept(new UpgradeRecipeBuilder.Result(pRecipeId, this.result, this.count, this.group == null ? "" : this.group, determineBookCategory(this.category), this.rows, this.key, this.advancement, pRecipeId.withPrefix("recipes/" + this.category.getFolderName() + "/"), this.showNotification));
    }
    ...
    public static class Result extends CraftingRecipeBuilder.CraftingResult {
        ...
        public void serializeRecipeData(JsonObject pJson) {
            ...
            pJson.remove("type");
            pJson.add("type", new JsonPrimitive("kjs_progression_extender:upgrade"));
